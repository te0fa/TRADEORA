...
## 📅 Emergency Hard Stop Strategy Plan

لتجنب مخاطر الانزلاق السعري الحاد والانهيارات المفاجئة قبل انتهاء الشمعة (خاصة للأسهم منخفضة السيولة)، يُضاف صمام أمان إضافي للعمل جنباً إلى جنب مع الوقف الأساسي:

### 1. تأكيد قيود الحدود السعرية (Price Limits Verification)
* **المتطلب:** قبل أي تطبيق برمجي، يجب الاستعلام المباشر وتأكيد قواعد الحدود السعرية (Circuit Breakers) وآلية إيقاف التداول المؤقت (حالياً 5% صعوداً/هبوطاً) والحدود السعرية اليومية (10% أو 20% حسب فئة السهم) من موقع البورصة المصرية الرسمي [egx.com.eg](http://www.egx.com.eg) أو نشرات الهيئة العامة للرقابة المالية.

### 2. طريقة الحساب الفني للوقف الكارثي
* **المعادلة:** يتم تحديد الوقف الكارثي بالاعتماد على التقلب الحقيقي للسهم وليس كنسبة ثابتة لضمان توافقه مع سلوك السهم:
  * *صيغة الشراء:* `Emergency SL = Entry Price - (ATR * multiplier)` (حيث يتم تحديد المعامل بعد الباك تيست).
  * *صيغة البيع:* `Emergency SL = Entry Price + (ATR * multiplier)`.

### 3. آلية التفعيل (Execution Trigger)
* **الشرط:** بعكس الوقف الأساسي (الذي ينتظر إغلاق الشمعة لتجنب صيد الوقف)، يتم تفعيل الوقف الكارثي **بشكل لحظي فوري (Touch Trigger)** بمجرد ملامسة السعر للوقف خلال الشمعة لتأمين رأس المال من الانهيارات السريعة.

### 4. الاختبار والتحقق الإلزامي (Mandatory Backtesting)
* **الخطوات:** قبل الانتقال للإنتاج، يجب إجراء اختبار باك تيست كامل ومنفصل بمقارنة 3 سيناريوهات (الوقف الأساسي وحده، الوقف الكارثي وحده، والاثنين معاً) على فريمين مختلفين على الأقل لتحديد المعامل المثالي لـ ATR وضمان عدم تقليل معدل الربحية العام بشكل سلبي.
