  ...
  return (companies || []).map((item: any) => {
    ...
    if (rawPrice) {
      priceRecord = {
        ...
        open_price: rawPrice.open_price != null ? Number(rawPrice.open_price) : null,
        high_price: rawPrice.high_price != null ? Number(rawPrice.high_price) : null,
        low_price:  rawPrice.low_price  != null ? Number(rawPrice.low_price)  : null,
