  ...
  try {
    ...
    if (exactLatest.arab_total_buy > 0) {
      if (exactLatest.arab_inst_buy === 0 && exactLatest.arab_ind_buy > 0) {
        ...
        exactLatest.arab_inst_sell = Math.max(0, exactLatest.arab_total_sell - exactLatest.arab_ind_sell);
        exactLatest.arab_inst_net  = exactLatest.arab_total_net  - exactLatest.arab_ind_net;
      } else if (exactLatest.arab_ind_buy === 0 && exactLatest.arab_inst_buy > 0) {
